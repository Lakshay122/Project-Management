...
const TaskColumn = ({
  ...
  return (
    <div
      ...
      className={`slpy-4 rounded-lg py-2 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neutral-950" : ""}`}
    >
...
const Task = ({ task }: taskProps) => {
  ...
  const formatterStartDate = task.startDate
          ...
          <div className="flex flex-1 flex-wrap items-center gap-2">
            ...
            <div className="flex gap-2">
              {taskTagsSplit.map((tag) => (
                <div
                  key={tag}
                  className="text-xd rounded-full bg-blue-100 px-2 py-1"
                >
                  {" "}
                  {tag}
                </div>
